...
screen navigation():
    ...
    vbox:
        ...
        textbutton _("Playground") action ShowMenu("playground")
...
## Pantalla de playground ######################################################
##
## El playground es un area para acceder a cada una de las diferentes mecanicas,
## aqui solo habra botones para acceder a cada una, ya sea que ocupen mostrar
## otra screen o un label
